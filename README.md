...
The bot that we have created specifically for this project is the [`shortPredictionBot`](https://github.com/TheLostLight/ModifiedNim/blob/main/NimBots.py#L228), which is described as "a bot that tries to predict the opponent" in the GUI. This is the best performing bot in terms of the specifications given in class that has a reasonable execution time.
...
## [Standard 1v1 Bot](https://github.com/TheLostLight/ModifiedNim/blob/main/NimBots.py#L22) <a name="std1v1bot"></a>
...
## [Gaurav's Test Bot](https://github.com/TheLostLight/ModifiedNim/blob/main/NimBots.py#L87) <a name="testbotdesc"></a>
...
## [Brute Force Bot](https://github.com/TheLostLight/ModifiedNim/blob/main/NimBots.py#L183) <a name="bruteforcedesc"></a>
...
## [Short Prediction Bot](https://github.com/TheLostLight/ModifiedNim/blob/main/NimBots.py#L228) <a name="shortpredictdesc"></a>
...
<br>
1. [getStandardChoice](https://github.com/TheLostLight/ModifiedNim/blob/main/NimBots.py#L37): O(n) + O(n) => O(n)
2. [getMisereChoice](https://github.com/TheLostLight/ModifiedNim/blob/main/NimBots.py#L57): O(n) + O(getStandardChoice) => O(n) + O(n) => O(n)
3. [playTurn](https://github.com/TheLostLight/ModifiedNim/blob/main/NimBots.py#L28): O(1)
...
<Strong>Methods:</strong>
1. [checkMove](https://github.com/TheLostLight/ModifiedNim/blob/main/NimBots.py#L93): O(n) 
2. [getNextMove](https://github.com/TheLostLight/ModifiedNim/blob/main/NimBots.py#L150): O(m)
3. [choosePile](https://github.com/TheLostLight/ModifiedNim/blob/main/NimBots.py#L93): O(n) + O(n) => O(n)
...
<Strong>Methods:</strong>
1. [getNimSum](https://github.com/TheLostLight/ModifiedNim/blob/main/NimBots.py#L238):  O(n)
2. [getZeroSumMoves](https://github.com/TheLostLight/ModifiedNim/blob/main/NimBots.py#L247): O(n) + O(n) => O(n)
3. [isTrap](https://github.com/TheLostLight/ModifiedNim/blob/main/NimBots.py#L263): O(n) + O(n) => O(n)
4. [makeChoice](https://github.com/TheLostLight/ModifiedNim/blob/main/NimBots.py#L299): O(n) + O(n) + O(n*m) + O(n) => O(m*n)
...
Our [`shortPredictionBot`](https://github.com/TheLostLight/ModifiedNim/blob/main/NimBots.py#L228) first checks for this special condition before attempting to create a nim-sum of zero. This guarantees that the bot follows optimal play when the only win condition is all empty piles.

## Accounting for Additional Win Conditions <a name="otherwincons"></a>

The [`shortPredictionBot`](https://github.com/TheLostLight/ModifiedNim/blob/main/NimBots.py#L228) accounts for other win conditions, and can account for any general win condition, with the [`isTrap`](https://github.com/TheLostLight/ModifiedNim/blob/main/NimBots.py#L263) method. A 'trap' in this case is defined as a move that results in a position that:
